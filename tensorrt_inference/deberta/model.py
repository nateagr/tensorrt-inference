...
from transformers.models.deberta_v2.modeling_deberta_v2 import (
    _CHECKPOINT_FOR_DOC, _CONFIG_FOR_DOC, ConvLayer, DebertaV2Intermediate,
    DebertaV2Output, DebertaV2SelfOutput, StableDropout, XSoftmax)
...
def make_log_bucket_dict(bucket_size, max_position, device=None):
    ...
    mid = bucket_size // 2
    abs_pos = torch.where(
        (relative_pos < mid) & (relative_pos > -mid), torch.tensor(mid - 1).to(relative_pos), torch.abs(relative_pos)
    )
